/**
 * =============================================================================
 *  SOURCE: vidsrc.to — Embed Player (may redirect to vsembed.ru)
 *  =============================================================================
 *  Fetches the embed page (which may 302-redirect) and extracts direct
 *  video URLs using regex strategies. Follows the redirect chain via
 *  http_get which handles redirects transparently.
 * =============================================================================
 */
...
async function scrapeStreams(params) {
	...
	try {
		// ── Fetch embed page HTML (http_get follows redirects) ────────────────
		var html;
		try {
		...
		// Strategy A: Direct M3U8 URLs (most common for this source)
		...
		// Strategy C: JavaScript config objects
		if (streams.length === 0) {
			var jsPatterns = [
