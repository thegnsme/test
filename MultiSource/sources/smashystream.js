/**
 * =============================================================================
 *  SOURCE: embed.smashystream.com — Embed Player → M3U8/MP4
 *  =============================================================================
 *  Fetches the embed page HTML and extracts direct video sources using
 *  multiple regex strategies (M3U8, MP4, iframe-following, JS configs).
 *
 *  Falls back gracefully if no direct sources are found.
 * =============================================================================
 */

var { httpGet } = require("./_shared");
var SOURCE_NAME = "embed.smashystream.com";
var BASE = "https://embed.smashystream.com";
...
async function scrapeStreams(params) {
	...
	try {
		...
		// ── Extract video sources using multiple strategies ───────────────────
		var streams = [];
		var seen = {};
		...
		// Strategy C: JS config objects (file/src/url keys)
		if (streams.length === 0) {
			var jsPatterns = [
